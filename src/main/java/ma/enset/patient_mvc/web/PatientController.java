...
public class PatientController {
    ...
    public String patients(Model model,
        ...
        Page<Patient> pagePatients = patientdao.findByNomContains(keyword, PageRequest.of(page, size));
    ...
    public String editPatients(Model model, Long id, String kw, int page) {
